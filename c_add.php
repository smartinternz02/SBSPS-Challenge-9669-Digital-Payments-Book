...
<head>
  ...
  <style type="text/css">
    #pandal-list{float:left;list-style:none;margin-top:-1%;padding:0;width:190px;position: absolute;margin-left:4%;z-index:2;}
#pandal-list li{padding: 10px; background: #9f373703; border-bottom: #bbb9b9 1px solid;}
#pandal-list li:hover{background:#9f373703;cursor: pointer;}
  </style>
</head>
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
	...
	<div class="row justify-content-center">
	 <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">CUSTOMER NAME</div>
          <div class="card-body">
            <div class="input-group">
              <div class="input-group-prepend">
                  <span class="input-group-text"><i aria-hidden="true" class="fa fa-user-circle"></i></span>
              </div>
              <input type="text" class="form-control" id="search-box" placeholder="CUSTOMER NAME" >
            </div>
            <div id="suggesstion-box"></div>
            <!-- <button type="button" class="btn btn-info btn-lg btn-round btn-block waves-effect waves-light m-1">PROCEED</button> -->
          </div>
        </div>
        <button type="button" class="btn btn-info btn-lg btn-round btn-block waves-effect waves-light m-1" id="but">PROCEED <i class="icon-login icons"></i></button>
      </div>
	</div><!--End Row-->
