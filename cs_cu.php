...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
	...
	<section class="chat-area">
      <header>
        <?php 
          $user_id = $_SESSION['REG_BY'];
          $sql = mysqli_query($con, "SELECT * FROM users WHERE ID = '".$_SESSION['REG_BY']."'");
        ...
        <img src="logo.png" id="fimg" alt="">
        <p style="color: black;"><?php echo($_SESSION['REG_BY_NAME']);?></p>
        <div class="details">
