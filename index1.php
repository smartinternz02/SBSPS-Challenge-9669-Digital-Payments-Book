...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    $sql="SELECT * FROM orde_r WHERE SID='".$_SESSION['ID']."' ";
...
?>
    ...
    $sql="SELECT * FROM users WHERE REG_BY='".$_SESSION['ID']."' ";
$result=mysqli_query($con,$sql);
if(mysqli_num_rows($result)>0)
{
...
$K=$row['DUE'];
  ...
  echo ('<h5 class="text-white mb-0">'.$K.'<span class="float-right"><i class="fa fa-inr"></i></span></h5>
                  ...
                  <p class="mb-0 text-white small-font">Total Due<span class="float-right">+'.$K.'% <i class="zmdi zmdi-long-arrow-up"></i></span>');
  }
else
{
  echo ('<h5 class="text-white mb-0">0<span class="float-right"><i class="fa fa-inr"></i></span></h5>
...
?>
    ...
    $sql="SELECT * FROM orde_r WHERE ACTIVE=1 AND SID='".$_SESSION['ID']."' ORDER BY DATE_TIME DESC";
$result=mysqli_query($con,$sql);
if(mysqli_num_rows($result)>0)
{
  while ($row=mysqli_fetch_assoc($result)) {
  echo('<tr>
                    ...
                    <td>'.$row['C_ID'].'</td>');
  $s=$row['C_ID'];
  $sl="SELECT * FROM users WHERE ID='".$s."'";
