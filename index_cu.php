...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    $sql="SELECT * FROM orde_r WHERE SID='".$_SESSION['REG_BY']."' AND C_ID='".$_SESSION['ID']."'";
...
?>
    ...
    $sql="SELECT * FROM users WHERE REG_BY='".$_SESSION['REG_BY']."' AND ID='".$_SESSION['ID']."' ";
$result=mysqli_query($con,$sql);
if(mysqli_num_rows($result)>0)
{
  //$count=mysqli_num_rows($result);
...
$KS=$row['DUE'];
  ...
  echo ('<h5 class="text-white mb-0">'.$KS.'<span class="float-right"><i class="fa fa-inr"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:'.$KS.'%"></div>
                    </div>
                  <p class="mb-0 text-white small-font">Total Due<span class="float-right">+'.$KS.'% <i class="zmdi zmdi-long-arrow-up"></i></span>');
  }
else
{
  echo ('<h5 class="text-white mb-0">0<span class="float-right"><i class="fa fa-inr"></i></span></h5>
                  ...
                  <p class="mb-0 text-white small-font">Total Due<span class="float-right">+0% <i class="zmdi zmdi-long-arrow-up"></i></span>');
}
?>
                  </p>
                </div>
...
$K=$row['REVENUE'];
  ...
  echo ('<h5 class="text-white mb-0">'.$K.'<span class="float-right"><i class="fa fa-eye"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:'.$K.'%"></div>
                    </div>
                  <p class="mb-0 text-white small-font">Paid<span class="float-right">+'.$K.'% <i class="zmdi zmdi-long-arrow-up"></i></span></p>');
   }
else
{
  echo ('<h5 class="text-white mb-0">0<span class="float-right"><i class="fa fa-eye"></i></span></h5>
                  ...
                  <p class="mb-0 text-white small-font">Paid<span class="float-right">+0% <i class="zmdi zmdi-long-arrow-up"></i></span></p>');
}
?>
    ...
    $sql="SELECT * FROM orde_r WHERE ACTIVE=1 AND SID='".$_SESSION['REG_BY']."' AND C_ID='".$_SESSION['ID']."' ORDER BY DATE_TIME DESC";
$result=mysqli_query($con,$sql);
if(mysqli_num_rows($result)>0)
{
  while ($row=mysqli_fetch_assoc($result)) {
