            ...
            <div class="card-body">
              <form id="tform" novalidate="novalidate">
               ...
               NEW PRODUCT
                ...
                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Product image</label>
                  <div class="col-sm-10">
                    <input type="file" class="form-control" id="input-8" name="pimg" required="">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-9" class="col-sm-2 col-form-label">Price</label>
                  <div class="col-sm-10">
                   <input type="number" class="form-control" id="input-5" name="price" required="">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <label for="input-9" class="col-sm-2 col-form-label">Product comment</label>
                  <div class="col-sm-10">
