   ...
   <div class="user-details">
    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
      <div class="avatar"></div>
       ...
       <h6 class="side-user-name"><?php echo($_SESSION['REG_BY_NAME'])?></h6>
      </div>
       </div>
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <div class="media-body">
            <h6 class="mt-2 user-title"><?php echo($_SESSION['REG_BY_NAME'])?></h6>
...
<div class="row">
   <div class="col-12 col-lg-12">
     <div class="card">
       <div class="card-header">Past Order Tables
    ...
    $sql="SELECT * FROM orde_r WHERE ACTIVE=0 AND C_ID='".$_SESSION['ID']."' ORDER BY DATE_TIME DESC";
