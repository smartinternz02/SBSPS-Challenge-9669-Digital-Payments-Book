...
<a href="product_add.php"><button type="button" class="btn btn-white btn-lg btn-round btn-block waves-effect waves-light m-1"><i class="icon-plus icons"></i>ADD NEW PRODUCT</button></a>
<br>
<br>
  ...
  <div class="row">
    ...
    $sql="SELECT * FROM product WHERE SID='".$_SESSION['ID']."'";
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <div class="input-group mb-3">
              ...
              <input id="'.$row['ID'].'" value="'.$row['STOCK'].'" type="number" class="form-control" placeholder="some text">

            </div>
            <button type="button" class="btn btn-primary waves-effect waves-light m-1" onclick="update('.$row['ID'].')" >Update Stock</button>
            <br>
            <div class="input-group mb-3">
              <br>
             <h4><i class="fa fa-inr"></i> </h4> <input id="'.$row['ID'].'pr" value="'.$row['PRICE'].'" type="number" class="form-control form-control-rounded" placeholder="some text">
              
            </div>
          <button type="button" class="btn btn-primary waves-effect waves-light m-1" onclick="pr('.$row['ID'].')" ><i class="fa fa-inr"></i> Update Price</button>
...
<script type="text/javascript">
  ...
  var data = {
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                  if(result=='ok')
                                  {
                                    swal(result, "STOCK UPDATED", "success");
                                }
    ...
    function pr(j)
  {
    ...
    var prw=document.getElementById(j+"pr").value;
    //alert(pr);
  var data = {
                            cmd: 'register',
                            p:j,
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                  if(result=='ok')
                                  {
                                    swal(result, "PRICE UPDATED", "success");
                                }
